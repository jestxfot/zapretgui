...
GOOGLEVIDEO_STRATEGIES = {
    ...
    "fake_fakedsplit_md5sig_80_port": {
        ...
        "author": None,
        "label": None,
        "args": f"""{GOOGLEVIDEO_BASE_ARG} --dpi-desync=fake,fakedsplit --dpi-desync-fooling=md5sig --dup=1 --dup-cutoff=n2 --dup-fooling=md5sig --dpi-desync-split-pos=midsld --dpi-desync-badseq-increment=10000000 --new"""
    },
    "fake_multisplit_datanoack_wssize_midsld": {
        ...
        "author": None,
        "label": LABEL_CAUTION,
        "args": f"""{GOOGLEVIDEO_BASE_ARG} ---dpi-desync=fake,multisplit --dpi-desync-fooling=datanoack --wssize 1:6 --dpi-desync-split-pos=midsld --dpi-desync-fake-tls-mod=rnd,dupsid,rndsni,padencap --new"""
    },
