...
TCP_STRATEGIES_BASE = {
    ...
    "other_seqovl": {
        ...
        "args": f"""--blob=bin_tls5:@{BIN_FOLDER}\\tls_clienthello_5.bin --payload=tls_client_hello --out-range=-d10 --lua-desync=multisplit:seqovl=211:seqovl_pattern=bin_tls5"""
    },
    "multisplit_sniext_midsld_18": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""--payload=tls_client_hello --out-range=-d10 --lua-desync=multisplit:pos=sniext+1,midsld:seqovl=652"""
    },
    "dis4": {
    ...
    "multisplit_308_pattern": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""--blob=bin_tls9:@{BIN_FOLDER}\\tls_clienthello_9.bin --payload=tls_client_hello --out-range=-n3 --lua-desync=send:repeats=2 --out-range=-d10 --lua-desync=multisplit:seqovl=308:seqovl_pattern=bin_tls9"""
    },
    ...
    "fakeddisorder_datanoack_1": {
        ...
        "author": None,
        "label": LABEL_RECOMMENDED,
        "args": f"""--payload=tls_client_hello --out-range=-d10 --lua-desync=fake:blob=0x00000000:tcp_flags_unset=ack --lua-desync=fakeddisorder:pos=midsld:tcp_flags_unset=ack"""
    },
    "other_multidisorder": {
    ...
    "googlevideo_fakedsplit": {
        ...
        "author": None,
        "label": LABEL_RECOMMENDED,
        "args": f"""--payload=tls_client_hello --out-range=-d10 --lua-desync=fakedsplit:pos=1:tcp_ack=-66000:repeats=10:ip_ttl=4:ip6_ttl=4"""
    },
    "googlevideo_split": {
