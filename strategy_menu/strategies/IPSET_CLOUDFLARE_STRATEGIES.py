...
BASE_ARG = "--filter-tcp=80,443,444-65535 --ipset=cloudflare-ipset.txt --ipset=ipset-cloudflare1.txt --ipset=ipset-cloudflare.txt"

IPSET_CLOUDFLARE_STRATEGIES = {
    "general_alt4_182": {
    ...
    "general_bf_2": {
        ...
        "author": "Flowseal",
        "label": LABEL_GAME,
        "args": f"""{BASE_ARG}  --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fake-tls-mod=none --dpi-desync-fooling=badseq"""
    },
    "other_seqovl": {
    ...
    "syndata_1": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=syndata --dpi-desync-fake-syndata=tls_clienthello_4.bin --dpi-desync-autottl"""
    },
    "syndata_4_badseq": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=syndata --dpi-desync-fake-syndata=tls_clienthello_4.bin --dpi-desync-fooling=badseq"""
    },
    "syndata_7_n3": {
        "name": "syndata 7 n3",
        "description": "Потом опишу подробнее",
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=syndata --dpi-desync-fake-syndata=tls_clienthello_7.bin --dup=2 --dup-cutoff=n3"""
    },
    "syndata_syn_packet_n3": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=syndata --dpi-desync-fake-syndata=syn_packet.bin --dup=2 --dup-cutoff=n3"""
    },
