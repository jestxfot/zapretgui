...
BASE_ARG = "--filter-tcp=80,443 --hostlist=youtube.txt"

# YouTube стратегии
YOUTUBE_TCP_STRATEGIES = {
    "fake_fakeddisorder_datanoack": {
        "name": "Ipset youtube",
    ...
    "multidisorder_seqovl_midsld": {
        ...
        "author": None,
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multidisorder --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=midsld-1"""
    },
