...
BASE_ARG = "--filter-tcp=80,443 --hostlist=telegram.txt"

# Стратегии для остальных сайтов
TELEGRAM_TCP_STRATEGIES = {
    "other_seqovl": {
        "name": "YTDisBystro 3.4 v1 (all ports)",
        "description": "Потом опишу подробнее",
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-seqovl=211 --dpi-desync-split-seqovl-pattern=tls_clienthello_5.bin"""
    },
    "other_seqovl_2": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multidisorder --dpi-desync-split-seqovl=211 --dpi-desync-split-seqovl-pattern=tls_clienthello_5.bin"""
    },
    "multisplit_286_pattern": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-seqovl=286 --dpi-desync-split-seqovl-pattern=tls_clienthello_11.bin --dup=2 --dup-cutoff=n3"""
    },
    "multisplit_226_pattern_18": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-seqovl=226 --dpi-desync-split-seqovl-pattern=tls_clienthello_18.bin --dup=2 --dup-cutoff=n3"""
    },
    "multisplit_226_pattern_google_Com": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-seqovl=226 --dpi-desync-split-seqovl-pattern=tls_clienthello_www_google_com.bin --dup=2 --dup-cutoff=d1"""
    },
    "multisplit_308_pattern": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-seqovl=308 --dpi-desync-split-seqovl-pattern=tls_clienthello_9.bin --dup=2 --dup-cutoff=n3"""
    },
    "multisplit_split_pos_1": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-split-pos=1"""
    },
    "datanoack": {
        "name": "datanoack",
        "description": "Потом опишу подробнее",
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync-fooling=datanoack"""
    },
    "multisplit_datanoack": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-fooling=datanoack"""
    },
    "multisplit_datanoack_split_pos_1": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=multisplit --dpi-desync-fooling=datanoack --dpi-desync-split-pos=1"""
    },
    "other_seqovl_fakedsplit_ttl2": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=fake,fakedsplit --dpi-desync-ttl=2 --dpi-desync-split-pos=1 --dpi-desync-fake-tls=0x00000000 --dpi-desync-fake-tls=! --dpi-desync-fake-tls-mod=rnd,rndsni,dupsid"""
    },
    "fakeddisorder_datanoack_1": {
        ...
        "author": None,
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=fake,fakeddisorder --dpi-desync-fooling=datanoack --dpi-desync-split-pos=midsld --dpi-desync-fake-tls=0x00000000"""
    },
    ...
    "original_bolvan_v2_badsum_max": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls-mod=rnd,dupsid,sni=web.max.ru"""
    },
    "other_multidisorder": {
        ...
        "author": "hz",
        "label": LABEL_STABLE,
        "args": f"""{BASE_ARG} --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig"""
    },
    "other_multidisorder_2": {
        ...
        "author": "hz",
        "label": LABEL_STABLE,
        "args": f"""{BASE_ARG} --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq,md5sig"""
    },
    "other2": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq"""
    },
    ...
    "telegram_tcp_none": {
        ...
        "description": "Отключить обработку Telegram трафика",
        "author": "System",
        "label": None,
        "args": ""
    }
