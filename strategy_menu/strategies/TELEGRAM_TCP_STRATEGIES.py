...
TELEGRAM_TCP_STRATEGIES = {
    "other_seqovl": {
        ...
        "args": f"""{BASE_ARG} --blob=bin_tls5:@{BIN_FOLDER}\\tls_clienthello_5.bin {RUTRACKER_BASE_ARG} --payload=tls_client_hello --out-range=-d10 --lua-desync=multisplit:seqovl=211:seqovl_pattern=bin_tls5"""
    },
    "other_seqovl_2": {
    ...
    "multisplit_226_pattern_18": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --payload=tls_client_hello --out-range=-n3 --lua-desync=send:repeats=2 --out-range=-d10 --lua-desync=multisplit:seqovl=226:seqovl_pattern=bin_tls18"""
    },
    "multisplit_226_pattern_google_Com": {
        ...
        "author": "hz",
        "label": None,
        "args": f"""{BASE_ARG} --payload=tls_client_hello --out-range=-d1 --lua-desync=send:repeats=2 --out-range=-d10 --lua-desync=multisplit:seqovl=226:seqovl_pattern=tls_google"""
    },
    ...
    "multisplit_split_pos_1": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --lua-desync=multisplit:pos=1"""
    },
    "datanoack": {
        "name": "datanoack",
        "description": "Потом опишу подробнее",
    ...
    "multisplit_datanoack": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --lua-desync=multisplit:pos=2:tcp_flags_unset=ack"""
    },
    "multisplit_datanoack_split_pos_1": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --lua-desync=multisplit:pos=1:tcp_flags_unset=ack"""
    },
    "other_seqovl_fakedsplit_ttl2": {
        ...
        "author": "hz",
        "label": LABEL_RECOMMENDED,
        "args": f"""{BASE_ARG} --lua-desync=fake:blob=fake_default_tls:ip_ttl=2:ip6_ttl=2:tls_mod=rnd,rndsni,dupsid --lua-desync=fakedsplit:pos=1:pattern=fake_default_tls:ip_ttl=2:ip6_ttl=2"""
    },
