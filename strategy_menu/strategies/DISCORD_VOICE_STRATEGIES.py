...
STUN = "--filter-l7=discord,stun"
IPSET = "--ipset=ipset-discord.txt"
...
DISCORD_VOICE_STRATEGIES = {
    "ipv4_dup2_autottl_cutoff_n3": {
        ...
        "args": f"""--filter-l3=ipv4 {STUN} --dpi-desync=fake --dpi-desync-autottl --dup=2 --dup-autottl --dup-cutoff=n3 --new --filter-l3=ipv6 {STUN} --dpi-desync=fake --dpi-desync-autottl6 --dup=2 --dup-autottl6 --dup-cutoff=n3"""
    },
    "fake_l7": {
        "name": "Fake L7",
    ...
    "dronatar_4_2": {
        ...
        "author": "Dronatar",
        "label": LABEL_RECOMMENDED,
        "args": f"""{STUN} --dpi-desync=fake --dpi-desync-fake-discord=0x00 --dpi-desync-fake-stun=0x00 --dpi-desync-repeats=6"""
    },
    "fake_tamper_repeats_6": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{STUN} --dpi-desync=fake,tamper --dpi-desync-repeats=6 --dpi-desync-fake-discord=0x00"""
    },
    "fake_any_proto_repeats_6_cutoff_n4": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{STUN} --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-any-protocol --dpi-desync-cutoff=n4"""
    },
    "fake_tamper_any_proto_repeats_11_cutoff_d5": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{STUN} --dpi-desync=fake,tamper --dpi-desync-any-protocol --dpi-desync-cutoff=d5 --dpi-desync-repeats=11"""
    },
    "fake_any_proto_quic1_cutoff_d2": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{STUN} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fake-quic=quic_1.bin"""
    },
    "fake_repeats_6": {
        "name": "Fake Repeats 6",
        ...
        "author": "Community",
        "label": None,
        "args": f"""{STUN} --dpi-desync=fake --dpi-desync-repeats=6"""
    },
    "ipset_fake_any_proto_cutoff_d3_repeats_6": {
        ...
        "author": "Community",
        "label": LABEL_RECOMMENDED,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6"""
    },
    "ipset_fake_any_proto_cutoff_d3_repeats_8": {
        ...
        "author": "Community",
        "label": LABEL_RECOMMENDED,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=8"""
    },
    "ipset_fake_any_proto_cutoff_d4_repeats_8": {
        ...
        "author": "Community",
        "label": LABEL_RECOMMENDED,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d4 --dpi-desync-repeats=8"""
    },
    "fake_any_proto_cutoff_n3": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=n3"""
    },
    "fake_split2_quic_test_cutoff_d2": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake,split2 --dpi-desync-any-protocol --dpi-desync-cutoff=d2 --dpi-desync-fake-quic=quic_test_00.bin"""
    },
    "fake_any_proto_google_quic_cutoff_n2": {
        ...
        "author": "Community",
        "label": LABEL_RECOMMENDED,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=n2 --dpi-desync-fake-quic=quic_initial_www_google_com.bin"""
    },
    "fake_any_proto_google_quic_cutoff_d3_repeats_6": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic=quic_initial_www_google_com.bin"""
    },
    "fake_tamper_any_proto_google_quic_cutoff_d3_repeats_6": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake,tamper --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic=quic_initial_www_google_com.bin"""
    },
    "fake_tamper_any_proto_google_quic_cutoff_n5_repeats_10": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake,tamper --dpi-desync-any-protocol --dpi-desync-cutoff=n5 --dpi-desync-repeats=10 --dpi-desync-fake-quic=quic_initial_www_google_com.bin"""
    },
    "fake_tamper_any_proto_google_quic_cutoff_n4": {
        ...
        "author": "Community",
        "label": None,
        "args": f"""{IPSET} --dpi-desync=fake,tamper --dpi-desync-any-protocol --dpi-desync-cutoff=n4 --dpi-desync-fake-quic=quic_initial_www_google_com.bin"""
    },
