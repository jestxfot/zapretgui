...
from .strategy_definitions import LABEL_CAUTION, LABEL_EXPERIMENTAL, LABEL_RECOMMENDED, LABEL_STABLE, LABEL_WARP 
...
--filter-tcp=80 --hostlist=other.txt --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=2 --dpi-desync-split-pos=sld+1 --dpi-desync-fake-http=0x0F0F0F0F --dpi-desync-fooling=md5sig --dup=2 --dup-fooling=md5sig --dup-cutoff=n3 --new
--filter-tcp=80 --ipset=ipset-all.txt --dpi-desync=fake,fakedsplit --dpi-desync-autottl=2 --dpi-desync-fooling=badseq --new
--filter-tcp=443 --hostlist-domains=roskomsvoboda.org,rublacklist.net,onlinesim.io,android.com,ntc.party,proton.me,moscowtimes.ru,dw.com,z-library.sk --hostlist=youtube.txt --hostlist=faceinsta.txt --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com --new
--filter-tcp=443 --hostlist-domains=static.rutracker.cc --hostlist=discord.txt --dpi-desync=fake,multisplit --dpi-desync-split-pos=sld+1 --dpi-desync-fake-tls=0x0F0F0E0F --dpi-desync-fake-tls=tls_clienthello_14.bin --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=badseq --dpi-desync-autottl --dup=2 --dup-fooling=badseq --dup-autottl --dup-cutoff=n3 --new
--filter-tcp=443,1024-65535 --ipset=ipset-all.txt --hostlist=other.txt --hostlist=russia-blacklist.txt --hostlist-exclude=faceinsta.txt --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --new {AMAZON_GAMES} {TCP_CLOUDFLARE_AMAZON_GAMES}
--filter-udp=443,444-65535 --hostlist-domains=awsglobalaccelerator.com,cloudfront.net,amazon.com,amazonaws.com,awsstatic.com,epicgames.com --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-fake-unknown-udp=quic_6.bin --dpi-desync-repeats=2 --dpi-desync-cutoff=n4 --dpi-desync-ttl=7 --new
--filter-udp=443,444-65535 --ipset=cloudflare-ipset.txt --ipset-exclude-ip=1.1.1.1,1.0.0.1,212.109.195.93,83.220.169.155,141.105.71.21,18.244.96.0/19,18.244.128.0/19 --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-fake-unknown-udp=quic_6.bin --dpi-desync-repeats=2 --dpi-desync-cutoff=n4 --dpi-desync-ttl=7 --new
...
--filter-tcp=443 --hostlist-domains=googlevideo.com --hostlist=russia-youtube.txt --hostlist=other.txt --hostlist=faceinsta.txt --hostlist-domains=www.xvideos.com,xvideos-cdn.com --dpi-desync=fake,multisplit --dpi-desync-split-pos=sld+1 --dpi-desync-fake-tls=0x0F0F0E0F --dpi-desync-fake-tls=tls_clienthello_14.bin --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=md5sig --dpi-desync-autottl --dup=2 --dup-fooling=md5sig --dup-autottl --dup-cutoff=n3 --new
...
--filter-tcp=443 --hostlist-domains=googlevideo.com --hostlist=russia-youtube.txt --dpi-desync=fake,multisplit --dpi-desync-split-pos=sld+1 --dpi-desync-fake-tls=0x0F0F0E0F --dpi-desync-fake-tls=tls_clienthello_14.bin --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=md5sig --dpi-desync-autottl --dup=2 --dup-fooling=md5sig --dup-autottl --dup-cutoff=n3 --new
--filter-tcp=80 --hostlist=mycdnlist.txt --hostlist=russia-blacklist.txt --hostlist=other.txt --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=2 --dpi-desync-split-pos=sld+1 --dpi-desync-fake-http=0x0F0F0F0F --dpi-desync-fooling=md5sig --dup=2 --dup-fooling=md5sig --dup-cutoff=n3 --new
...
--filter-tcp=443 --hostlist=russia-blacklist.txt --hostlist=other.txt --hostlist=mycdnlist.txt --dpi-desync=fake,multisplit --dpi-desync-split-pos=sld+1 --dpi-desync-fake-tls=0x0F0F0E0F --dpi-desync-fake-tls=tls_clienthello_14.bin --dpi-desync-fake-tls-mod=rnd,dupsid --dpi-desync-fooling=md5sig --dpi-desync-autottl --dup=2 --dup-fooling=md5sig --dup-autottl --dup-cutoff=n3 --new
...
--filter-tcp=443 --hostlist-exclude=netrogat.txt --dpi-desync=fake,fakedsplit --dpi-desync-split-pos=1 --dpi-desync-fake-tls=tls_clienthello_9.bin --dpi-desync-fooling=badseq --dpi-desync-autottl"""
    ...
    "bystro292_1": {
        ...
        "description": "Универсальная стратегия с fakeddisorder и wssize",
        "version": "1.3",
        "provider": "universal",
        "author": "KDS",
        "updated": "2025-04-27",
...
--filter-tcp=80 --dpi-desync=fake,fakedsplit --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --new
--filter-tcp=443 --hostlist=youtube.txt --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=11 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,dupsid,sni=www.google.com --new
--filter-tcp=443 --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq,md5sig --new
--filter-udp=443 --hostlist=youtube.txt --dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-udp=443 --dpi-desync=fake --dpi-desync-repeats=11 --new
--filter-udp=50000-50099 --filter-l7=discord,stun --dpi-desync=fake"""
    },
...
--filter-tcp=443 --hostlist=discord.txt --ipset=ipset-cloudflare.txt --dpi-desync=fake,multisplit --dpi-desync-ttl=1 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"""
    ...
    "multisplitmd5sigpadencapwssize": {
        "name": "multisplit 1,md5sig padencap wssize (discord)",
        "description": "Использует multisplit midsld, размер окна wssize и уникальный флаг rnd,rndsni,padencap",
        "version": "1.2",
        "provider": "Билайн",
        "author": "Unknown",
        "updated": "2025-03-25",
...
--filter-udp=50000-59000 --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-udp=443 --hostlist=youtubeQ.txt --dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-tcp=443 --dpi-desync=fake,multisplit --dpi-desync-ttl=1 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --wssize=1:6"""
    },
    "md5sigpadencapwssize": {
        "name": "md5sig padencap wssize (20.03.2025)",
        "description": "Использует midsld, размер окна wssize и уникальный флаг rnd,rndsni,padencap",
        "version": "1.2",
        "provider": "Билайн",
        "author": "Unknown",
        "updated": "2025-03-20",
...
--filter-tcp=443 --dpi-desync=fake --dpi-desync-fooling=md5sig --wssize=1:6 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"""
    ...
    "badsumpadencapwssize": {
        "name": "badsum padencap wssize (06.08.2025)",
        "description": "Использует badsum, размер окна wssize и уникальный флаг rnd,rndsni,padencap",
        "version": "1.2",
        "provider": "Билайн",
        "author": "Unknown",
        "updated": "2025-03-20",
...
--filter-udp=50000-59000 --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-udp=443 --hostlist=youtubeQ.txt --dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-tcp=443 --dpi-desync=fake --dpi-desync-fooling=badsum --wssize=1:6 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"""
    },
    "datanoackpadencapmidsldwssize": {
        "name": "datanoack padencap midsld wssize (20.03.2025)",
        "description": "Использует datanoack, midsld, размер окна wssize и уникальный флаг rnd,rndsni,padencap",
        "version": "1.2",
        "provider": "Билайн",
        "author": "Unknown",
        "updated": "2025-03-20",
...
--filter-udp=50000-59000 --dpi-desync=fake --dpi-desync-any-protocol --dpi-desync-cutoff=d3 --dpi-desync-repeats=6 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-udp=443 --hostlist=youtubeQ.txt --dpi-desync=fake --dpi-desync-repeats=11 --dpi-desync-fake-quic=quic_initial_www_google_com.bin --new
--filter-tcp=443 --dpi-desync=fake,fakeddisorder --dpi-desync-fooling=datanoack --dpi-desync-split-pos=midsld --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --wssize=1:6"""
    },
    "discordtcp80": {
        "name": "Discord TCP 80",
