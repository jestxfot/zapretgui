...
start "zapret: winws custom 4" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="discord.txt" --hostlist="faceinsta.txt" --ipset="ipset-cloudflare.txt" --hostlist="other.txt" --hostlist="youtube.txt" --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern="tls_clienthello_www_google_com.bin" --new ^
