...
start "zapret: winws Fake_Tls_Mod_v2" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="discord.txt" --hostlist="youtube.txt" --hostlist="other.txt" --ipset="ipset-cloudflare.txt" --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --new