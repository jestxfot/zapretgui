...
start "zapret: winws custom 15" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="discord.txt" --hostlist="youtube.txt" --hostlist="faceinsta.txt" --hostlist="other.txt" --ipset="ipset-cloudflare.txt" --dpi-desync=fake --dpi-desync-ttl=4 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --new