...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_MGTS_v4.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""youtube.txt"" --hostlist=""other.txt"" --hostlist=""faceinsta.txt"" --ipset=""ipset-cloudflare.txt"" --dpi-desync=fake,split2 --dpi-desync-split-seqovl=2 --dpi-desync-split-pos=3 --dpi-desync-fake-tls=""tls_clienthello_www_google_com.bin"" --dpi-desync-ttl=3 --new"
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""discord.txt"" --hostlist=""other.txt"" --hostlist=""faceinsta.txt"" --ipset=""ipset-cloudflare.txt"" --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-fooling=badseq --dpi-desync-repeats=10 --dpi-desync-ttl=4"
