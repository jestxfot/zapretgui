...
start "zapret: winws custom 5" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="youtube.txt" --hostlist="discord.txt" --hostlist="other.txt" --hostlist="faceinsta.txt" --ipset="ipset-cloudflare.txt" --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --new ^
