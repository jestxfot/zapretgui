...
:: -------------------------------------------------------------------------
:: 1. Проверяем, администратор ли скрипт
:: -------------------------------------------------------------------------
net session >nul 2>&1
if %errorlevel% neq 0 (
...
:: -------------------------------------------------------------------------
:: 2. Убираем вспомогательный аргумент, если был
:: -------------------------------------------------------------------------
if /i "%1"=="ELEV" shift /1

:: -------------------------------------------------------------------------
:: 3. Запускаем winws.exe (окно свернуто)
:: -------------------------------------------------------------------------
...
start "zapret: http,https,quic" /min "winws.exe" ^
