...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_md5sig_padencap_wssize.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --dpi-desync=fake --dpi-desync-fooling=md5sig --wssize 1:6 --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"
