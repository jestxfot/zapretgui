@echo off
REM Стратегия multisplit 1,md5sig padencap (discord)
REM VERSION: 1.0
REM Дата обновления: 2025-03-25
...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_multisplit_md5sig_padencap_discord.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""discord.txt"" --ipset=""ipset-cloudflare.txt"" --dpi-desync=fake,multisplit --dpi-desync-ttl=1 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"
