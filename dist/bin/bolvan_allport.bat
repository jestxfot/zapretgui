@echo off
REM Стратегия bol-van v3 (все порты)
REM VERSION: 2.2
...
--wf-l3=ipv4,ipv6 --wf-tcp=80,443,444-50000 --wf-udp=443,50000-50099 ^
...
--filter-tcp=443 --hostlist-exclude-domains=lmarena.ai,gitflic.ru,searchengines.guru,habr.com,cdn.ampproject.org,st.top100.ru,rootsplants.co.uk,podviliepitomnik.ru,cvetovod.by,veresk.by,use.fontawesome.com,xn--p1ai --dpi-desync=fake,multidisorder --dpi-desync-split-pos=1,midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq,md5sig --new ^
--filter-tcp=444-50000 --dpi-desync=syndata --new ^
