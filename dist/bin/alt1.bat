...
start "zapret: winws custom 3" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="discord.txt" --hostlist="faceinsta.txt" --ipset="ipset-cloudflare.txt" --hostlist="other.txt" --hostlist="youtube.txt" --dpi-desync=fake,split --dpi-desync-autottl=5 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="tls_clienthello_www_google_com.bin" --new ^
