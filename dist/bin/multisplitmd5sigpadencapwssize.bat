@echo off
REM Стратегия multisplit 1,md5sig padencap wssize (discord)
REM VERSION: 1.0
...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_multisplit_md5sig_padencap_wssize_discord.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --dpi-desync=fake,multisplit --dpi-desync-ttl=1 --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,rndsni,padencap --wssize 1:6"
