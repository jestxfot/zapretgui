...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_Rostelecom_Megafon.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""discord.txt"" --dpi-desync=fake,split --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls=""tls_clienthello_www_google_com.bin"" --new"
