...
start "zapret: winws custom 6" /b "winws.exe" ^
 ...
 --filter-tcp=443 --hostlist="youtube.txt" --hostlist="discord.txt" --hostlist="other.txt" --hostlist="faceinsta.txt" --ipset="ipset-cloudflare.txt" --dpi-desync=fake,split2 --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls="tls_clienthello_www_google_com.bin" --new ^
