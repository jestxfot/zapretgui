...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_md5sig_padencap_Beeline.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""discord.txt"" --ipset=""ipset-cloudflare.txt"" --dpi-desync=fake --dpi-desync-fooling=md5sig --dpi-desync-fake-tls-mod=rnd,rndsni,padencap"
