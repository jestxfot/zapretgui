...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("\n⚠️ Установите сертификат вручную:")
        print("   1. Найдите файл zapret_certificate.cer")
        print("   2. Двойной клик → 'Установить сертификат'")
        print("   3. 'Доверенные корневые центры сертификации'")
