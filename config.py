...
BIN_FOLDER, LISTS_FOLDER, APP_VERSION = "bin", "lists", "14.5.0"
...
YT12 = f"{YT} --dpi-desync=fake,split2 --dpi-desync-split-seqovl=625 --dpi-desync-split-tls=sniext --dpi-desync-fake-tls={BIN_FOLDER}/tls_clienthello_vk_com.bin --dpi-desync-ttl=2 --new"
...
"Дискорд fake":  f"{WF_TCP} --wf-udp=443,50000-59000 {YQ1} {YGV1} {YT1} {DISUDP1} {UDP1} {DISTCP1} {other1} {faceinsta}",
"Дискорд fake и split":  f"{WF_TCP} --wf-udp=443,50000-50100 {DISUDP3} {DISIP1} {DISTCP80} {DISTCP3} {YQ1} {YGV1} {YT2} {other1} {faceinsta}",
...
"Ростелеком и Мегафон":  f"{WF_TCP} --wf-udp=443,50000-59000 {YQ2} {YT4} {DISUDP3} {UDP3} {DISTCP6} {other1} {faceinsta}",
"Ростелеком и МГТС":  f"{WF_TCP} --wf-udp=443,50000-59000 {YQ3} {YT5} {DISUDP3} {UDP3} {DISTCP6} {other1} {faceinsta}",
"Другие провайдеры v1": f"--wf-l3=ipv4,ipv6 --wf-tcp=443 --wf-udp=443,50000-65535 {YQ4} {YT3} {DISTCP7} {DISUDP6} {UDP4} {other1} {faceinsta}",
"Другие провайдеры v2": f"--wf-l3=ipv4,ipv6 --wf-tcp=443 --wf-udp=443,50000-65535 {YQ4} {YT6} {DISUDP7} {UDP5} {DISTCP8} {other1} {faceinsta}",
...
"МГТС v1":  f"{WF_TCP} --wf-udp=443,50000-50010 {YGV1} {YT7} {DISIP1} {DISTCP9} {other1} {faceinsta}",
"МГТС v2":  f"{WF_TCP} --wf-udp=443,50000-50900 {YT8} {DISTCP10} {YQ5} {DISUDP1} {other1} {faceinsta}",
"МГТС v3":  f"{WF_TCP} --wf-udp=443,50000-50900 {YT7} {DISTCP10} {YQ5} {DISUDP1} {UDP1} {other1} {faceinsta}",
"МГТС v4":  f"{WF_TCP} --wf-udp=443,50000-50900 {YQ1} {YGV3} {YT1} {DISUDP1} {UDP1} {DISTCP1} {other1} {faceinsta}",
