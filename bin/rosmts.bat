...
setlocal
set "BIN=%~dp0"
set "vbsSilent=%BIN%runsilent_Rostelecom_MGTS.vbs"
> "%vbsSilent%" (
    ...
    echo cmd = cmd ^& " --filter-udp=443 --hostlist=""youtubeQ.txt"" --dpi-desync=fake --dpi-desync-repeats=4 --dpi-desync-fake-quic=""quic_1.bin"" --new"
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""youtube.txt"" --dpi-desync=fake,split2 --dpi-desync-split-seqovl=2 --dpi-desync-split-pos=3 --dpi-desync-fake-tls=""tls_clienthello_2.bin"" --dpi-desync-autottl=2 --new"
    ...
    echo cmd = cmd ^& " --filter-tcp=443 --hostlist=""discord.txt"" --hostlist=""other.txt"" --hostlist=""faceinsta.txt"" --ipset=""ipset-cloudflare.txt"" --dpi-desync=fake,split --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls=""tls_clienthello_www_google_com.bin"" --new"
